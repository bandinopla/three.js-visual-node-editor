...
export class Theme {
    ...
    readonly outletRadius = 5;

    readonly errorBorderColor: FillStyle = 'red';
    ...
    readonly scriptSocketColor: FillStyle = '#00ffcc';
    ...
    readonly comboStrokeColor: FillStyle = '#3d3d3d';

    readonly inputTextBg: FillStyle = '#545454';
    readonly inputTextColor: FillStyle = 'white';

    readonly paramNameBgColor: FillStyle = '#4a138f';
    readonly paramNameTextColor: FillStyle = 'white';

    readonly dangerBgColor: FillStyle = '#c02643';
}
