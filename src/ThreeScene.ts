...
export class ThreeScene extends THREE.EventDispatcher<SceneEvents> {
    ...
    constructor() {
        ...
        this.pointLight = new THREE.PointLight(0xffffff, 15, 2);
    ...
    protected buildScene() {
        ...
        const sphere = new THREE.Mesh(new THREE.SphereGeometry(2), material);
        sphere.name = "Sphere";
        ...
        loader.load(
            import.meta.env.BASE_URL + "monkey.glb",
            (gltf) => {
    ...
    private updateLightPosition() {
        ...
        const vector = new THREE.Vector3(this.mouse.x, this.mouse.y, 1); // Z = 0.5 in NDC (midway in the frustum)
